...
class AppTheme {
  static const Color cBg = Color(0xFFFFFBEB);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFFDE68A);
  static const Color cAccent = Color(0xFFEA580C);
  static const Color cAccent2 = Color(0xFFFB923C);
  static const Color cInk = Color(0xFF431407);
